...
class TestTransitionTrajectory(unittest.TestCase):
    ...
    def test_valid_transition_medium_to_small(self):
        TransitionSubgait.from_subgait_names(self.gait_selection, old_gait_name, new_gait_name, subgait_name)
